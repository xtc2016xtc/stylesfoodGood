...
const Mediaido  = ({ isVisible, onClose }:MediaidoProps) => {
    ...
    return (
        <div className="absolute z-10 left-0 top-0 w-full h-full overflow-hidden bg-black bg-opacity-75 flex items-center justify-center">
            <div className="relative w-full h-full">
                <button onClick={onClose} className="absolute z-10 top-4 right-4 bg-white text-black p-2 rounded">关闭</button>
